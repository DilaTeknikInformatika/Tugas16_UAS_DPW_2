               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        <h1 class="about_taital">Tentang Mine Shope</h1>
         ...
         <div class="container">
            ...
            <div class="contact_section_2">
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="footer_logo_1"><a href="index.php"><h3 class="address_text">Mine Shope</h3></a></div>
